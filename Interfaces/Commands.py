...
class Commands(object):
    ...
    def __init__(self, single_transfer):
        ...
        self.cmd_list["CMDID_UNLOCK_FULL_BAND"]      = (0x0003, self.cmd_unlock_full_band) 
        # Raw Data Commands
    ...
    def cmd_set_sys_params(self):
        ...
        '''=========================================================================='''
    def cmd_unlock_full_band(self):
        SndLenE = [2,2,2]
        SndpL = []
        SndpL.append(self.sysParams.key)

        self.doTransfer(SndLenE = SndLenE,SndpL = self.sysParams.key)
